...
class HomePage(Page):
    ...
    _signin_link = 'signin'
    _signout_link = "//header[@id='app-header']/div[2]/nav/ul/li[3]/span/a[2]"
    _my_account_link = "//header[@id='app-header']/div/nav/ul/li[3]/span/a[1]"
    ...
    _addon_view_btn = "//div[@id='libs-and-extensions']/div[1]/ul[1]/li[1]/ul/li[2]/a"
    ...
    def click_signout(self):
        #self.sel.find_element_by_xpath(self._create_addon_btn).click()
        self.sel.find_element_by_xpath(self._signout_link).click()
        self.sel.implicitly_wait(10)
        return
...
#Takes you to your dashboard
    ...
    def click_addon_view_btn(self):
        self.sel.find_element_by_xpath(self._addon_view_btn).click()
        self.sel.implicitly_wait(10)
        return
